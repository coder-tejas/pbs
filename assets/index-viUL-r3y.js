...
function qu (e, n, t) {
  ...
  return { $$typeof: gc, type: e, key: o, ref: i, props: l, _owner: Sc.current }
}
br.Fragment = wc
br.jsx = qu
br.jsxs = qu
...
function vs () {
  if (Kn) {
    var e = Kn,
      n = Yn
    if (((Yn = Kn = null), Hi(e), n)) for (e = 0; e < n.length; e++) Hi(n[e])
  }
}
function hs (e, n) {
  return e(n)
...
function dt (e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    uo ||
      ((uo = !0), ye.unstable_scheduleCallback(ye.unstable_NormalPriority, qc)))
}
function Dt (e) {
  function n (l) {
    return dt(l, e)
...
function qo (e, n, t, r) {
  if (jr) {
    var l = so(e, n, t, r)
    if (l === null) Ml(e, n, r, Dr, t), Ki(e, r)
...
var vf = V({}, Gt, {
  ...
  wf = we(gf),
  kf = V({}, ot, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Sf = we(kf),
  Ef = V({}, nl, {
    deltaX: function (e) {
...
function Pf (e, n) {
  if (Dn)
    return e === 'compositionend' || (!ti && Ds(e, n))
...
function Rf (e, n, t) {
  e === 'focusin'
    ? (tu(), (Ct = n), (It = t), Ct.attachEvent('onpropertychange', $s))
    : e === 'focusout' && tu()
}
function Of (e) {
...
function ka (e, n, t) {
  return Pn & 21
    ? (Me(t, n) || ((t = _s()), (A.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function bf (e, n, t) {
  ...
  if (Ea(e)) xa(n, l)
    ...
    ;(t = ra(e, n, l, r)),
      t !== null && ((l = ie()), Oe(t, e, r, l), Ca(t, n, r))
  }
}
function Ea (e) {
  var n = e.alternate
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (U && t && li(n), (n.flags |= 1), oe(e, n, r, l), n.child)
  )
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (U && r && li(n), (n.flags |= 1), oe(e, n, t, l), n.child)
  )
}
function zu (e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    ...
    var v = t.getDerivedStateFromProps,
      m =
        typeof v == 'function' || typeof i.getSnapshotBeforeUpdate == 'function'
    m ||
...
function _o (e, n, t, r, l, o) {
  Ta(e, n)
  var i = (n.flags & 128) !== 0
  if (!r && !i) return l && pu(n, t, !1), Ye(e, n, o)
...
function Va (e, n, t) {
  for (var r = (e.mode & 1) !== 0; S !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (S = o)) : ju(e)
  }
}
function ju (e) {
  for (; S !== null; ) {
...
function Ba (e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = io(e)), l !== 0 && ((r = l), (n = Do(e, l)))), n === 1)
    )
...
function Jr (e, n) {
  ...
  while (!0)
  if ((si(), (R = t), (Xr.current = r), K !== null)) throw Error(y(261))
  return (J = null), (b = 0), X
}
function md () {
  for (; K !== null; ) Qa(K)
...
Xa = function (e, n, t) {
  ...
  else (ce = !1), U && n.flags & 1048576 && qs(n, Vr, n.index)
  switch (((n.lanes = 0), n.tag)) {
    case 2:
      var r = n.type
      _r(e, n), (e = n.pendingProps)
      var l = qn(n, le.current)
      Gn(n, t), (l = hi(null, n, r, e, l, t))
      var o = yi()
      return (
        (n.flags |= 1),
        typeof l == 'object' &&
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Eo(n, r, e, t),
            (n = _o(null, n, r, !0, o, t)))
          : ((n.tag = 0), U && o && li(n), oe(null, n, l, t), (n = n.child)),
        n
      )
    case 16:
      r = n.elementType
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zo(n, t | 1), pe(n, Q()), !(R & 6) && ((rt = Q() + 500), vn()))
      }
      break
    case 13:
      Ln(function () {
...
hs = Ci
ys = Ln
var Nd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, ms, vs, Ci] },
  ht = {
...
ge.hydrateRoot = function (e, n, t) {
  ...
  if (
    ...
    (n = Ja(n, null, e, 1, t ?? null, l, !1, o, i)),
    (e[Qe] = n.current),
    Ut(e),
    r)
  )
...
const Ld = '/dist/assets/book-DxCqERiI.png'
function Td () {
  return D.jsxs('div', {
    className: 'container',
    children: [
      D.jsxs('nav', {
        className: 'navbar',
        children: [
          D.jsx('div', { className: 'logo', children: 'BookStore' }),
          D.jsxs('ul', {
            className: 'nav-links',
            children: [
              D.jsx('li', { children: 'Home' }),
              D.jsx('li', { children: 'Categories' }),
              D.jsx('li', { children: 'About' }),
              D.jsx('li', { children: 'Contact' })
            ]
          }),
          D.jsx('button', { className: 'login-btn', children: 'Login' })
        ]
      }),
      D.jsxs('div', {
        ...
        children: [
          D.jsxs('div', {
            ...
            children: [
              D.jsx('h1', { children: 'Your Mind Deserves the Best Books' }),
              D.jsx('p', {
                children:
              ...
              D.jsxs('div', {
                ...
                children: [
                  D.jsx('p', { children: 'Also Available On' }),
                  D.jsxs('div', {
                    className: 'store-icons',
                    children: [
                      D.jsx('img', {  alt: 'Amazon' }),
                      D.jsx('img', {  alt: 'Kindle' })
                    ]
                  })
                ]
              })
          ...
          D.jsx('div', {
            ...
            children: D.jsx('img', { src: Ld, alt: 'Book' })
          })
        ]
      })
    ]
...
ec(document.getElementById('root')).render(
  D.jsx(Vo.StrictMode, { children: D.jsx(Td, {}) })
)
